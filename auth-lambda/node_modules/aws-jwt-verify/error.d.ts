 ...
 */
export declare class AlbJwtInvalidSignerError extends JwtInvalidClaimError {
}
export declare class AlbJwtInvalidClientIdError extends JwtInvalidClaimError {
}
export declare class AlbJwksNotExposedError extends JwtBaseError {
}
/**
 * JWK errors
 */
